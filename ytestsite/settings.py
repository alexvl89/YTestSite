"""
Django settings for ytestsite project.
...
SECRET_KEY = ')jpv9qet_f*$_^dtia*rt59y4*msmsa&zano=aj!3(^hoymz7@'
...
ROOT_URLCONF = 'ytestsite.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        # место поиска шаблонов
...
WSGI_APPLICATION = 'ytestsite.wsgi.application'
